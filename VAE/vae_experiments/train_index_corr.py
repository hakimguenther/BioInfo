...
from vae import VAE
from dataset_index import BioData
...
def loss_function(x, x_hat, mean, log_var):
    ...
    # KLD = torch.tensor(0.1).to(mean.device)
...
# dataset cluster
base_dir = "/prodi/hpcmem/spots_ftir_corr/"
...
batch_size = 4
experiment_name = "all_corr_data_scaled_with_global_index_based_min_max_optimized_combined_loss"
...
model_dir = os.path.join(expeBriment_dir, "models")
