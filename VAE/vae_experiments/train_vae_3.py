...
# train the VAE
# model_name = "corr_vae_2_cont_1_best.pth"
# model_path = os.path.join(experiment_dir, "models", model_name)
# checkpoint = torch.load(model_path)

model = VAE_3(device=device).to(device)
