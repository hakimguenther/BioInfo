...
### Main function ####
def test_model(model, normal_loader, abnormal_loader, docs_path, device, model_name, annotate_abnormal_points=False):

    global annotate_points
    annotate_points = annotate_abnormal_points
    ...
    pca_fig = plot_pca(normal_z, abnormal_z, abnormal_file_paths)
